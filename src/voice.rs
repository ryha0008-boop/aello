...
/// No-op off Windows: the AppUserModelID and the protocol are Windows concepts,
/// and `notify.py --register` says as much rather than doing anything.
#[cfg(not(windows))]
pub fn ensure_notify_registered(_env_dir: &Path) {}
