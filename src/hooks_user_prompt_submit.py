...
INSTRUCTION = (
    ...
    "a plan to read.\n\n"
    "When anything is left for the user to do, close the prose with 3–5 "
    "numbered steps: what they do next, in order, each one concrete enough to "
    "act on without reading a word above it. Their actions, not yours — steps "
    "you are about to take yourself are a plan. Leave the list out when "
