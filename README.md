...
- **Same manners everywhere** — four rules ride every prompt in every env: be concise, don't be sycophantic, never hand over a plan for approval (plan mode is blocked outright), and end with that spoken `TL;DR:` line.
